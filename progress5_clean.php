...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($payload !== null) {
        ...
        header('Location: progress5.php?submitted=1'); // Redirect to current page
        exit;
    }
}
...
<head>
    ...
    <title>Progress Assessment 5 - Cognitive Domain | Yakap Daycare Center</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content" id="main-content">
            <!-- Header -->
            <div class="header">
                <h1><i class="fas fa-chart-line"></i> Progress Assessment 5 - Cognitive Domain</h1>
            ...
            <div class="content">
                ...
                <h2 class="form-title" id="form-title">Progress Assessment 5 - Cognitive Domain</h2>
                ...
                <form method="post" action="">
                    ...
                    <table class="assessment-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1. Recognizes and names primary colors (red, blue, yellow, green)</td>
                                <td>
                            ...
                            <tr>
                                <td>3. Recognizes basic shapes (circle, square, triangle, rectangle)</td>
                                <td>
                            ...
                            <tr>
                                <td>4. Sorts objects by size (big/small) and color</td>
                                <td>
                            ...
                            <tr>
                                <td>5. Completes simple puzzles (3-5 pieces)</td>
                                <td>
