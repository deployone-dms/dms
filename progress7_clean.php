...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($payload !== null) {
        ...
        header('Location: progress7.php?submitted=1'); // Redirect to current page
        exit;
    }
}
...
<head>
    ...
    <title>Progress Assessment 7 - Self-Help Skills | Yakap Daycare Center</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content" id="main-content">
            <!-- Header -->
            <div class="header">
                <h1><i class="fas fa-chart-line"></i> Progress Assessment 7 - Self-Help Skills</h1>
            ...
            <div class="content">
                ...
                <h2 class="form-title" id="form-title">Progress Assessment 7 - Self-Help Skills</h2>
                ...
                <form method="post" action="">
                    ...
                    <table class="assessment-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1. Feeds self with spoon and fork</td>
                                <td>
                            ...
                            <tr>
                                <td>2. Drinks from a cup without spilling</td>
                                <td>
                            ...
                            <tr>
                                <td>3. Washes hands independently</td>
                                <td>
                            ...
                            <tr>
                                <td>4. Puts on and takes off simple clothing items</td>
                                <td>
                            ...
                            <tr>
                                <td>5. Uses the toilet independently</td>
                                <td>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" class="btn-next" id="nextBtn" style="display: none;">Next</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        document.getElementById('nextBtn').addEventListener('click', function() {
            // This is the last page, so show completion message
