...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($payload !== null) {
        ...
        header('Location: progress3_clean.php?submitted=1'); // Stay on page
        exit;
    }
}
...
<head>
    ...
    <title>Progress Assessment 3 - Receptive Language Domain | Yakap Daycare Center</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content" id="main-content">
            <!-- Header -->
            <div class="header">
                <h1><i class="fas fa-chart-line"></i> Progress Assessment 3 - Receptive Language Domain</h1>
            ...
            <div class="content">
                ...
                <h2 class="form-title" id="form-title">Progress Assessment 3 - Receptive Language Domain</h2>
                ...
                <form method="post" action="">
                    ...
                    <table class="assessment-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>1. Points to a family member when asked to do so</td>
                                    <td>
                                ...
                                <tr>
                                    <td>2. Points to five body parts on himself when asked to do so</td>
                                    <td>
                                ...
                                <tr>
                                    <td>3. Points to five named pictured objects when asked to do so</td>
                                    <td>
                                ...
                                <tr>
                                    <td>4. Follows one-step instructions that include simple prepositions (e.g., in, on, under, etc.)</td>
                                    <td>
                                ...
                                <tr>
                                    <td>5. Follows two-step instructions that include simple prepositions</td>
                                    <td>
