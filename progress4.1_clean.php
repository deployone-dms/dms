...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($payload !== null) {
        // Ensure table exists (stores submissions as JSON text) and student_id column for per-student linkage
        $conn->query(
        ...
        // Backfill student_id column / index in case table exists
        ...
        header('Location: progress4.1_clean.php?submitted=1'); // Stay on this page after save
        exit;
    }
}
...
<head>
    ...
    <title>Progress Assessment 4.1 - Expressive Language Domain | Yakap Daycare Center</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content" id="main-content">
            <!-- Header -->
            <div class="header">
                <h1><i class="fas fa-chart-line"></i> Progress Assessment 4.1 - Expressive Language Domain</h1>
            ...
            <div class="content">
                ...
                <h2 class="form-title" id="form-title">Progress Assessment 4.1 - Expressive Language Domain</h2>
                
                <form method="post" action="">
                    <?php $preSid = isset($_GET['student_id']) ? intval($_GET['student_id']) : 0; ?>
                    <?php if ($preSid > 0): ?>
                        <input type="hidden" name="student_id" value="<?php echo $preSid; ?>">
                    <?php else: ?>
                    <div style="margin-bottom:15px; display:flex; gap:10px; align-items:center;">
                        <label for="student_id" style="font-weight:700; color:#1B5E20;">Select Student:</label>
                        <select name="student_id" id="student_id" required style="padding:10px; border:2px solid #E9ECEF; border-radius:8px;">
                            <option value="">-- choose --</option>
                            <?php 
                            $ss = $conn->query("SELECT id, first_name, last_name FROM students WHERE archived=0 ORDER BY last_name, first_name");
                            if ($ss) { while($st = $ss->fetch_assoc()) { echo '<option value="'.intval($st['id']).'">'.htmlspecialchars($st['last_name'].', '.$st['first_name'])."</option>"; } }
                            ?>
                        </select>
                    </div>
                    <?php endif; ?>
                    ...
                    <table class="assessment-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1. Says "mama" or "dada" or equivalent</td>
                                <td>
                            ...
                            <tr>
                                <td>2. Says at least two words</td>
                                <td>
                            ...
                            <tr>
                                <td>3. Says at least five words</td>
                                <td>
                            ...
                            <tr>
                                <td>4. Says at least ten words</td>
                                <td>
                            ...
                            <tr>
                                <td>5. Combines two words to make a phrase</td>
                                <td>
    ...
    <script>
        ...
        document.getElementById('prevBtn').addEventListener('click', function() {
            window.location.href = 'progress4.php';
        });
