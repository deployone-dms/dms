...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($payload !== null) {
        ...
        header('Location: progress6.php?submitted=1'); // Redirect to current page
        exit;
    }
}
...
<head>
    ...
    <title>Progress Assessment 6 - Social-Emotional Domain | Yakap Daycare Center</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content" id="main-content">
            <!-- Header -->
            <div class="header">
                <h1><i class="fas fa-chart-line"></i> Progress Assessment 6 - Social-Emotional Domain</h1>
            ...
            <div class="content">
                ...
                <h2 class="form-title" id="form-title">Progress Assessment 6 - Social-Emotional Domain</h2>
                ...
                <form method="post" action="">
                    ...
                    <table class="assessment-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1. Shows interest in other children</td>
                                <td>
                            ...
                            <tr>
                                <td>2. Plays alongside other children (parallel play)</td>
                                <td>
                            ...
                            <tr>
                                <td>3. Shares toys and materials with others</td>
                                <td>
                            ...
                            <tr>
                                <td>4. Takes turns in simple games and activities</td>
                                <td>
                            ...
                            <tr>
                                <td>5. Shows empathy and comfort to others when they are upset</td>
                                <td>
