...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($payload !== null) {
        // Ensure table exists with student_id column
        $conn->query(
        ...
        header('Location: progress4.3_clean.php?submitted=1'); // Stay on page
        exit;
    }
}
...
<head>
    ...
    <title>Progress Assessment 4.3 - Expressive Language Domain | Yakap Daycare Center</title>
...
<body>
    <div class="container">
        ...
        <div class="main-content" id="main-content">
            <!-- Header -->
            <div class="header">
                <h1><i class="fas fa-chart-line"></i> Progress Assessment 4.3 - Expressive Language Domain</h1>
            ...
            <div class="content">
                ...
                <h2 class="form-title" id="form-title">Progress Assessment 4.3 - Expressive Language Domain</h2>
                ...
                <form method="post" action="">
                    ...
                    <table class="assessment-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1. Uses "yes" and "no" appropriately</td>
                                <td>
                            ...
                            <tr>
                                <td>2. Uses "more" and "all done" appropriately</td>
                                <td>
                            ...
                            <tr>
                                <td>3. Uses "help" and "stop" appropriately</td>
                                <td>
                            ...
                            <tr>
                                <td>4. Uses "up" and "down" appropriately</td>
                                <td>
                            ...
                            <tr>
                                <td>5. Uses "big" and "little" appropriately</td>
                                <td>
